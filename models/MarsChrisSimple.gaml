...
global {
	...
	float sublimCO2param <- 3000000.0;
    ...
    reflex saving_ when: cycle > 1 and (
    	...
    	loop n over: cell  {
    	    ...
    	    if    ((cycle - 1) / 2 = 591 // mid N winter  , za: https://mars.nasa.gov/all-about-mars/facts/mars-year/
